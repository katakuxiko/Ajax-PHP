	...
	<div class="main">
		<div class="container py-5 ">
			<div class="row g-5">
				...
				<a href="search.php" class="btn btn-primary">Перейти на страницу с поиском</a>
								...
								<div class="col-lg-4 col-md-6">
									<div class="card">
										...
										<div class="card-body px-5">
											...
											<a href="?delete=<?= $value['id'] ?>" class="btn btn-primary btn-sm mt-2" data-toggle="modal" data-target="#deleteModal<?= $value['id'] ?>">Полное содержание</a>
											<?php require 'fullModal.php'; ?>
										</div>
									</div>
								</div>
							<?php } ?>
